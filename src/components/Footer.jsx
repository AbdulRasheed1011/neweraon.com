    ...
    <footer className="footer">
      <div className="footer-grid">
        <div className="footer-brand">
          <div className="footer-logo">AR<span className="gt">.</span></div>
          <p className="footer-tagline">
            AI/ML Engineer building enterprise-grade intelligent systems — from production RAG pipelines to fine-tuned LLMs deployed at scale.
          </p>
